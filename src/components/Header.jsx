    ...
    <aside className="w-full h-[10%] flex justify-start items-center bg-white/10 text-primary overflow-hidden rounded-[12px] p-2">
      ...
      >
        <div className="h-full w-full rounded-[12px] relative overflow-hidden">
          <div class="h-[10%] px-5 bg-[#ffffff10]  rounded-t-[20px]">
            <div class="h-full flex justify-between items-center text-white">
              <div class="flex justify-start items-center gap-1 md:gap-3">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
                ...
                <h1 class="text-xl lg:text-2xl font-bold whitespace-nowrap">
                  Site Saver
                </h1>
              </div>
